...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pawket-light via-pawket-neutral to-white relative overflow-hidden">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-8 animate-fade-in">
          ...
          <div className="pt-12 opacity-60">
            <div className="flex justify-center space-x-8">
              <div className="w-2 h-2 bg-pawket-accent rounded-full animate-bounce"></div>
              <div className="w-2 h-2 bg-pawket-primary rounded-full animate-bounce delay-100"></div>
              <div className="w-2 h-2 bg-pawket-accent rounded-full animate-bounce delay-200"></div>
            </div>
          </div>
        </div>
      </div>
